...
#         @current_resource.permissions(CernerSplunk::ConfHelpers.read_config(new_resource.perms_file))
...
#         app_conf = CernerSplunk::ConfHelpers.parse_config tarfile.get_file('default/app.conf')
