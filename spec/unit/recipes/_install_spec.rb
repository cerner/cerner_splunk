...
describe 'cerner_splunk::_install' do
  ...
  let(:splunk_file) { 'splunkforwarder-6.6.0-1c4f3bbe1aea' }
  ...
  before do
    ...
    allow(Dir).to receive(:glob).with('/opt/splunkforwarder/splunkforwarder-6.6.0-1c4f3bbe1aea-*').and_return(glob)
