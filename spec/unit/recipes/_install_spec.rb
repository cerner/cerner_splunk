...
describe 'cerner_splunk::_install' do
  ...
  let(:splunk_file) { 'splunkforwarder-7.2.4.2-fb30470262e3' }
  ...
  before do
    ...
    allow(Dir).to receive(:glob).with('/opt/splunkforwarder/splunkforwarder-7.2.4.2-fb30470262e3-*').and_return(glob)
