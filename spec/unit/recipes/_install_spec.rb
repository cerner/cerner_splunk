...
describe 'cerner_splunk::_install' do
  ...
  let(:splunk_file) { 'splunkforwarder-8.0.7-cbe73339abca' }
  ...
  before do
    ...
    allow(Dir).to receive(:glob).with('/opt/splunkforwarder/splunkforwarder-8.0.7-cbe73339abca-*').and_return(glob)
