...
describe 'cerner_splunk::_install' do
  ...
  let(:splunk_file) { 'splunkforwarder-7.0.4-68ba48f99743' }
  ...
  before do
    ...
    allow(Dir).to receive(:glob).with('/opt/splunkforwarder/splunkforwarder-7.0.4-68ba48f99743-*').and_return(glob)
