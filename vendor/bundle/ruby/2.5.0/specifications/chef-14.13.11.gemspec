...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mixlib-log>.freeze, ["< 4.0", ">= 2.0.3"])
      s.add_runtime_dependency(%q<mixlib-authentication>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<mixlib-shellout>.freeze, ["< 4.0", ">= 2.4"])
      ...
      s.add_dependency(%q<mixlib-log>.freeze, ["< 4.0", ">= 2.0.3"])
      s.add_dependency(%q<mixlib-authentication>.freeze, ["~> 2.1"])
      s.add_dependency(%q<mixlib-shellout>.freeze, ["< 4.0", ">= 2.4"])
