...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<mixlib-cli>.freeze, ["< 3.0", ">= 1.7"])
      ...
      s.add_runtime_dependency(%q<addressable>.freeze, ["< 2.8", ">= 2.3.5"])
      s.add_runtime_dependency(%q<cookbook-omnifetch>.freeze, ["~> 0.5"])
      s.add_runtime_dependency(%q<diff-lcs>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<paint>.freeze, ["< 3", ">= 1"])
      s.add_runtime_dependency(%q<license-acceptance>.freeze, [">= 1.0.11", "~> 1.0"])
    else
      s.add_dependency(%q<mixlib-cli>.freeze, ["< 3.0", ">= 1.7"])
      ...
      s.add_dependency(%q<addressable>.freeze, ["< 2.8", ">= 2.3.5"])
      s.add_dependency(%q<cookbook-omnifetch>.freeze, ["~> 0.5"])
      s.add_dependency(%q<diff-lcs>.freeze, ["~> 1.0"])
      s.add_dependency(%q<paint>.freeze, ["< 3", ">= 1"])
      s.add_dependency(%q<license-acceptance>.freeze, [">= 1.0.11", "~> 1.0"])
    end
  else
    s.add_dependency(%q<mixlib-cli>.freeze, ["< 3.0", ">= 1.7"])
    s.add_dependency(%q<mixlib-shellout>.freeze, ["< 4.0", ">= 2.0"])
